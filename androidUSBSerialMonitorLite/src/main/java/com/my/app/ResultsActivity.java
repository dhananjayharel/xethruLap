...
public class ResultsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        results.add( new ResultModel("Lucas","3","11 June 2013 10.00am",11,22,11.4));
        results.add( new ResultModel("Oliver","6","11 Aug 2013 8.00am",11,22,11.4));
        results.add( new ResultModel("Mason","11","5 Jan 2014 10.00am",14,43,11.4));
        results.add( new ResultModel("Aiden","12","8 July 2014 2.00pm",11,22,11.4));
